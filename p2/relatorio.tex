...
interno, o processo administrativo, o papel das \textit{soft skills}, a relação
de suas práticas com a evolução do pensamento administrativo e, por fim, uma
reflexão crítica que confronta teoria e prática. Para tanto, a metodologia
combina a revisão dos conceitos das escolas Clássica, das Relações Humanas e
Sistêmica com a caracterização de uma empresa de pequeno porte do setor de
tecnologia, permitindo observar como princípios administrativos consagrados
continuam (ou não) aplicáveis a um negócio jovem, intensivo em conhecimento e
...
Jônatas Brito), que uniram trajetórias complementares para proteger o elo mais
frágil da cadeia de segurança: as pessoas.

A complementaridade dos fundadores é um dos pilares do negócio: Bruno Viana
traz dez anos em auditoria, base para os processos de \textit{compliance} e
avaliação de riscos; Felipe Koike soma nove anos como analista de dados sênior
em uma instituição bancária, decisivos para a análise de indicadores e métricas
de segurança; e Jônatas Brito reúne quatro anos em infraestrutura de TI e três
como desenvolvedor \textit{backend}, garantindo a base técnica para testes,
simulações e desenvolvimento de soluções internas.
...
organizações que buscam reduzir incidentes por erro humano e fortalecer sua
cultura de segurança.

\subsection{Estrutura organizacional básica}

A Sentinela Cyber organiza-se em três áreas, cada uma liderada por um sócio
fundador e padronizada com sete integrantes: o diretor da área, um gerente de
projetos (PM) ou \textit{product owner} (PO), quatro colaboradores e um
estagiário. Esse desenho equilibra as três frentes, totaliza vinte e uma
pessoas e cria um caminho claro de carreira. A divisão de responsabilidades
acompanha as especialidades de cada fundador:
...
Dentro de cada área, o diretor responde pela estratégia e pelo relacionamento
com os clientes; o PM ou PO coordena o fluxo de trabalho e faz a interface com
a equipe técnica; os quatro colaboradores executam as atividades-fim
(auditorias, análises de dados ou operações técnicas); e o estagiário apoia as
tarefas operacionais, sustentando o pilar de Evolução Contínua e a renovação de
talentos. Trata-se de uma estrutura predominantemente funcional, organizada por
especialidade, na qual a padronização das equipes favorece a coordenação, a
previsibilidade da capacidade produtiva e a escalabilidade do negócio.
...
O processo administrativo, consolidado na literatura clássica, compreende
quatro funções interligadas (planejamento, organização, direção e controle),
descritas a seguir conforme se manifestam na Sentinela Cyber.
...
profissional, a motivação é sustentada pelo propósito comum e pela autonomia
técnica de cada um. A comunicação é direta e horizontal, favorecida pela
proximidade entre as equipes, e o trabalho em equipe é condição para a entrega
dos projetos, que combinam competências de auditoria, análise de dados e
tecnologia.
...
fortemente de \textit{soft skills}. A própria atividade-fim, que é conscientizar
pessoas sobre segurança, exige comunicação, didática e empatia para traduzir
conceitos técnicos a públicos não especializados. Destacam-se como competências
comportamentais críticas:
...
prática. Por um lado, sustenta-se sobre princípios clássicos (planejamento,
organização, direção e controle), que permanecem relevantes mesmo em uma
empresa jovem e tecnológica; por outro, sua dinâmica cotidiana aproxima-se das
abordagens humanística e sistêmica, evidenciando que a gestão contemporânea
valoriza pessoas, flexibilidade e adaptação ao ambiente. Observa-se, contudo,
uma lacuna no campo da formalização: muitos processos ainda dependem do
conhecimento tácito dos sócios, o que contraria os princípios de documentação e
padronização e representa um risco à escalabilidade.
...
disciplina de Administração de Negócios com a realidade de uma consultoria em
segurança da informação. Verificou-se que, embora recente e intensivo em
tecnologia, o negócio se apoia em funções administrativas clássicas e, ao mesmo
tempo, incorpora de maneira intensa as contribuições das escolas de Relações
Humanas e Sistêmica, coerentes com um modelo centrado nas pessoas. A
complementaridade dos fundadores e a cultura ancorada em quatro pilares (Defesa
Coletiva, Confiança em Rede, Integridade Inegociável e Evolução Contínua)
constituem seu principal diferencial competitivo, ao passo que a dependência
das pessoas-chave e a baixa formalização de processos apontam o caminho de
amadurecimento gerencial.

Conclui-se que a evolução do pensamento administrativo não é meramente
histórica, mas cumulativa: as boas práticas de cada escola coexistem na gestão
contemporânea. Para a Sentinela Cyber, o desafio futuro consiste em equilibrar a
flexibilidade e o capital humano que a tornam competitiva com a estruturação de
processos que assegurem sua escalabilidade e perenidade.
